...
start() {
    clear
    echo -e "
    ${RESET}${txtbgrst}${BLUE}${BOLD}########## ADB MENU ##########${WHITE}
    ${BOLD}1.  Run adb Preset inside the script
...
clear
echo "
${RESET}${txtbgrst}${BLUE}${BOLD}########## ADB START ##########${WHITE}
...
sleep 2
echo "
${RESET}${txtbgrst}${BLUE}${BOLD}########### FINISH ############${RESET}
...
${RESET}${txtbgrst}${BLUE}${BOLD}########## ADB RESET ##########${WHITE}
${RESET}${txtinv}${BOLD}Press ENTER to start${RESET}
"
read -r a
...
sleep 2
echo "
${RESET}${txtbgrst}${BLUE}${BOLD}########### FINISH ############${WHITE}
${RESET}${txtinv}${BOLD}Press ENTER to return to START${RESET}"
read -r a
exit 0
}
