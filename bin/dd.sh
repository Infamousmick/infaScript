...
possible_partitions=("/dev/block/by-name/" "/dev/block/sdcard" "/dev/block/by-num/" "/dev/block/bootdevice/by-name/" "/dev/block/bootdevice/sdcard" "/dev/block/bootdevice/by-num/")
