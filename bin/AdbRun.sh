...
if [ $boot_count -gt 10 ] && [ $boot_count -le 50 ]; then
    echo -e "${BOLD}Your boot count stands at ${txtbgred}${BOLD}$boot_count!${RESET}
    ...
    echo -e "${BOLD}OMG!! Your boot count stands at ${txtbgred}${BOLD}$boot_count!${RESET}
    ${BOLD}MUST reset to 0..."
    settings put global boot_count 0
    settings put global Phenotype_boot_count 0
    echo "Resetted to 0"
elif [ $boot_count -gt 100 ]; then
    echo -e "${BOLD}OH JESUS CHRIST!! You are FOOLISH!! The boot count stands at ${txtbgred}${BOLD}$boot_count!${RESET}
    ${BOLD}MUST HAVE TO RESET TO 0, ${txtbgblu}MADE IN HEAVEN...${RESET}${BOLD}"
    settings put global boot_count 0
    settings put global Phenotype_boot_count 0
    echo -e "Resetted to 0"
else
    echo -e "${BOLD}Have boot count set to ${txtbgred}${BOLD}$boot_count${RESET}${BOLD}, no need to reset"
fi
